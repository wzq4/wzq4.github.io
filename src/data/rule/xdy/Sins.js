    ...
    details: [
        {
            ...
            contents: [
                { type: "card-warning", name: "就是不怕死（#P0LPPQL8Y）", reasons:["不上位捐兵（第2次，禁赛10场）", "总计禁赛10场，剩余7场"] },
                { type: "card-warning", name: "之镰（#PG2CYQ8GR）", reasons:["不上位捐兵（第1次）", "总计禁赛5场，剩余5场"] },
                { type: "card-warning", name: "二龍村（#9U9V0URQJ）", reasons:["不上位捐兵（第1次）", "部落战参加不打（第1次，禁8场）", "总计禁赛13场，剩余13场"] },
