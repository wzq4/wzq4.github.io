    ...
    details: [
        {
            ...
            contents: [
                { type: "card-warning", name: "就是不怕死（#P0LPPQL8Y）", reasons:["不上位捐兵（第2次，禁赛10场）", "总计禁赛10场，剩余6场"] },
                { type: "card-warning", name: "之镰（#PG2CYQ8GR）", reasons:["不上位捐兵（第1次）", "总计禁赛5场，剩余4场"] },
                { type: "card-warning", name: "二龍村（#9U9V0URQJ）", reasons:["不上位捐兵（第1次）", "部落战参加不打（第1次，禁8场）", "总计禁赛13场，剩余12场"] },
                { type: "card-warning", name: "来来来（#PJV20CQCG）", reasons:["不上位捐兵（第1次）", "总计禁赛5场，剩余5场"] },
                { type: "card-warning", name: "落翊（#YQ2892UJR）", reasons:["不上位捐兵（第1次）", "总计禁赛5场，剩余5场"] },
