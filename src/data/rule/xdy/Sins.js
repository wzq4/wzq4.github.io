    ...
    details: [
        {
            ...
            contents: [
                { type: "card-warning", name: "疾影灬鸿蒙（#9YVC09GLQ）", reasons:["部落战参加不打，禁赛8场", "剩余8场"] },
                { type: "card-warning", name: "专属（#9PPQVQ2CQ）", reasons:["部落战参加不打，禁赛8场", "剩余8场"] },
                { type: "card-warning", name: "烈焰风暴防区（#8VJLVPYL9）", reasons:["部落战没有打全2场，禁赛8场", "剩余8场"] },
                { type: "card-warning", name: "中国合作伙伴（#PJOUQLJ8L）", reasons:["部落战没有打全2场，禁赛8场", "剩余8场"] },
                { type: "card-warning", name: "死亡/魔都（#Y29U2R9CG）", reasons:["部落战参加不打，禁赛8场", "剩余7场"] },
                { type: "card-warning", name: "咕噜部落（#2CGYCRG8J）", reasons:["部落战参加没有打全2场，禁赛8场", "剩余6场"] },
                ...
                { type: "card-warning", name: "顾陈是个坑（#PGYPV9VVC9）", reasons:["部落战参加没有打全2场，禁赛8场", "剩余4场"] },
